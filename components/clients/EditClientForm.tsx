...
import type { Client, LeadReferral, ClientType } from '@/types'
...
export default function EditClientForm({ client }: { client: Client }) {
  ...
  const [avatarColorVal, setAvatarColorVal] = useState<string | null>(client.avatar_color ?? null)
  ...
  const previewColor = avatarColor(form.name || client.name, avatarColorVal)
